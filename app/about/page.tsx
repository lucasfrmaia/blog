         ...
         >
            <div className="lg:w-1/2">
               ...
               <p className="text-lg text-muted-foreground mb-8">
                  ...
                  conhecimento e experiências no mundo do desenvolvimento web.
                  Aqui, transformamos conceitos complexos em conteúdo acessível
                  e prático.
               </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground">
                        Técnicas e estratégias para otimização de aplicações web
